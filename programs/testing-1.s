...
;
print_log:
    mov 1.L, [10 + 0xD0000]    ; Load 8-bit char from address in R10 into R1.L
...
strcmp_loop:
    mov 1.L, [10 + 0x00] ; Load 8-bit character from s1 (R10) into R1.L
    mov 2.L, [11 + 0x00] ; Load 8-bit character from s2 (R11) into R2.L
